...
");
    ...
    <p>
        <table >
            ...
            <tr>
                <td colspan="2" style="text-align: left"><strong>Référence du courrier : DT-<?= date('Y'); ?>/SEP-L/<?= ($cpt<10?'00'.$cpt:$cpt); ?></strong><br/><br/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2"><br/><br/>
                    ...
                    <br/>
                        ...
                        <br/> <br/>
                        Au vu de la sinistralité, nous vous informons que votre contrat sera résilié à son échéance. <br/>
