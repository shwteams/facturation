...
<page backtop="30mm" backleft="14mm" backright="20mm" backbottom="14mm">
    ...
    <page_footer>
        ...
        <hr style=" height:1px;border:none;color:red;background-color:red;margin-top: 0;">
...
");
    ...
    <p>
        <table >
            ...
            <tr>
                <td colspan="2" style="text-align: left"><strong>Référence du courrier : DT-<?= date('Y'); ?>/SEP-RN/<?= ($cpt<10?'00'.$cpt:$cpt); ?> </strong><br/><br/></td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left"><strong>Objet : RESILIATION A L’ECHEANCE </strong></td>
            </tr>
            <tr>
    ...
    <p>
        ...
        Nous vous informons que votre contrat ci-dessus, arrive à échéance  le <strong><?= date("d/m/Y", strtotime($item_result['dt_FIN_GARANTIE'])); ?> à minuit</strong>.
        <br/>
        ...
        <br/> <br/>
        Au vu de votre sinistralité, nous vous informons que votre contrat sera résilié à son échéance.<br/>
        Conformément aux dispositions de l’article 23 du CODE CIMA, nous vous signifions avoir observé le préavis d’un mois. <br/>
